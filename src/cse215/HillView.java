...
public class HillView extends JFrame{
	...
	HillView(User user, int x, int y)
	
	{
		...
		ImageIcon hotelImg = new ImageIcon(getClass().getResource("images/HillView.png"));
		...
		JLabel priceName = new JLabel("<html>PRICE : Double Bed Tk. 4000(incl. 15% vat) per night<br>"
				+ "Single Bed Tk. 3500(incl. 15% vat) per night</html>");
