...
public class RegularView extends JFrame{
	...
	RegularView(User user, int x, int y)
	{
		/*********************** Same Everywhere**********************/
		...
		ImageIcon hotelImg = new ImageIcon(getClass().getResource("images/Regular.png"));
		...
		offerName.setBounds(250,450,700,50);
		offerName.setFont(new Font("Arial", Font.BOLD,25));
		c.add(offerName); 

		JLabel priceName = new JLabel("<html>PRICE :Double bed Tk. 3000(incl. 15% vat) per night<br>"
				+ "Single bed Tk. 2500(incl. 15% vat) per night</html>");
		priceName.setBounds(250,500,700,60);
