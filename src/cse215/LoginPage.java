...
public class LoginPage extends JFrame{
	...
	LoginPage(int x, int y)
	{
		...
		this.setBounds(x,y, 1000,800);	//changed
		...
		ImageIcon hotelImg = new ImageIcon(getClass().getResource("images/hotel3.png"));
		JLabel hotelIcon = new JLabel(hotelImg);
		hotelIcon.setBounds(175,110,150,150);	//image of bank in login page
		c.add(hotelIcon);

		JLabel welcome = new JLabel("GUEST LOGIN");
		welcome.setForeground(Color.BLACK);
		welcome.setFont(new Font("Didot",Font.BOLD,65));
		welcome.setBounds(325, 115, 600,150);
		c.add(welcome);

		//label
		usernameLabel = new JLabel("USERNAME:");
		usernameLabel.setFont(new Font("Ariel",Font.BOLD,25));
		usernameLabel.setBounds(250,260,200,50);
		c.add(usernameLabel);
		//textFiled
		usernameText = new JTextField();
		usernameText.setFont(new Font("Gotham",Font.PLAIN,20));
		usernameText.setHorizontalAlignment(JTextField.CENTER);
		usernameText.setBounds(250, 310, 500,50);
		c.add(usernameText);
		...
		errorLabel.setBounds(370, 500, 350,120);
		c.add(errorLabel);
		//Button
		...
		loginButton.setBounds(250, 600, 200,70);
		c.add(loginButton);
		...
		cancelButton.setBounds(550, 600, 200, 70);
		c.add(cancelButton);
